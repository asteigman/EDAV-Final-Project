...
# roommate said this is super difficult to follow if you've never seen this kind of graph before. obvi joyce and TAs will know what it is, but she was so so confused and kept asking Qs.
...
Throughout our analysis of opioid use, we often compare users to non-users. We define a "user" as someone who has used any sort of prescription painkiller nonmedically at least once in their lives, and according to the survey data, just under 15% of respondents are opioid users.
#Jo recommends we make a "snapshot" of the results here or at least what we're even going to look at.
...
# she got confused here that we jumped from income straight to the histogram of this variable. she recommends putting both graphs together to help users see that this graph is for context of the ANYLRTOT variable.
...
ggplot(tidy_act_yth, aes(Opioid)) + 
  ...
  scale_fill_manual(values=c("#0072B2", "#CC79A7"))
```
# jo thought the no yes on bottom and on right was confusing. maybe we change legend labels to "did not participate" and "participated" ?
